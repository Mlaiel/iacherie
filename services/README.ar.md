...
تُنفذ وحدة الخدمات في منصة IA Chérie هندسة خدمات مصغرة عالمية المستوى للمؤسسات مع فصل ثلاثي الطبقات لتحقيق أفضل قابلية للتوسع والأمان والأداء.
...
- **الحالة**: [status.iacherie.com](https://status.iacherie.com)
