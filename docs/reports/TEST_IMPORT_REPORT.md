...
- **Fichiers importés :** 253
- **Adaptations effectuées :** 432
...
- Import adapté: from backend.ai.core.base_models import ( -> from ai.core.base_models import (
- Import adapté: from backend.ai.core.exceptions import ModelError, ValidationError -> from ai.core.exceptions import ModelError, ValidationError
- Import adapté: from backend.ai.core.content_processor import ( -> from ai.core.content_processor import (
- Import adapté: from backend.ai.core.validation import ContentType, ValidationResult -> from ai.core.validation import ContentType, ValidationResult
- Import adapté: from backend.ai.core.exceptions import ContentGenerationError, OptimizationError, ProtectionError -> from ai.core.exceptions import ContentGenerationError, OptimizationError, ProtectionError
- Import adapté:             import backend.ai.core as core_module ->             import ai.core as core_module
- Import adapté:             from backend.ai.core.config import ( ->             from ai.core.config import (
- Import adapté:             from backend.ai.core.exceptions import ( ->             from ai.core.exceptions import (
- Import adapté:             from backend.ai.core.metrics import ( ->             from ai.core.metrics import (
- Import adapté:             from backend.ai.core.performance import ( ->             from ai.core.performance import (
- Import adapté:             from backend.ai.core.validation import ( ->             from ai.core.validation import (
- Import adapté:             from backend.ai.core.config import CoreConfig, ConfigManager ->             from ai.core.config import CoreConfig, ConfigManager
- Import adapté:             from backend.ai.core.metrics import MetricsCollector ->             from ai.core.metrics import MetricsCollector
- Import adapté:             from backend.ai.core.performance import PerformanceMonitor ->             from ai.core.performance import PerformanceMonitor
- Import adapté:             from backend.ai.core.validation import ContentValidator ->             from ai.core.validation import ContentValidator
- Import adapté:                 from backend.ai.core.config import CoreConfig, ValidationConfig ->                 from ai.core.config import CoreConfig, ValidationConfig
- Import adapté:             from backend.ai.core.config import CoreConfig, PipelineConfig ->             from ai.core.config import CoreConfig, PipelineConfig
- Import adapté:             from backend.ai.core.config import CoreConfig ->             from ai.core.config import CoreConfig
- Import adapté:             from backend.ai.core.config import CoreConfig ->             from ai.core.config import CoreConfig
- Import adapté:             from backend.ai.core.config import CoreConfig ->             from ai.core.config import CoreConfig
