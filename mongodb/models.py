...
Data models and schemas for MongoDB collections in the IA Chérie platform.
...
class User(BaseModel):
    """User model for IA Chérie platform."""
    user_id: str
    email: str
    username: str
...
class MongoDBModels:
    """Collection of MongoDB models for IA Chérie platform."""
