...
================================================================================
Module: backend/core/managers/session_manager.py
...
class SessionManagerConfig:
    """Configuration du gestionnaire SessionManager"""    pool_size: int = 10
...
class SessionManager(ABC):
    """    🎯 Gestionnaire SessionManager - IA-Influencer-Agent
...
def get_session_manager() -> SessionManager:
    ...
    Returns:
        SessionManager: Instance du gestionnaire
