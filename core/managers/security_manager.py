...
================================================================================
Module: backend/core/managers/security_manager.py
...
class SecurityManagerConfig:
    """Configuration du gestionnaire SecurityManager"""    pool_size: int = 10
...
class SecurityManager(ABC):
    """    🎯 Gestionnaire SecurityManager - IA-Influencer-Agent
    ...
    def __init__(self, config: SecurityManagerConfig = None):
        self.config = config or SecurityManagerConfig()
        self._pool = []
...
def get_security_manager() -> SecurityManager:
    ...
    Returns:
        SecurityManager: Instance du gestionnaire
