...
================================================================================
Module: backend/core/managers/resource_manager.py
...
class ResourceManagerConfig:
    """Configuration du gestionnaire ResourceManager"""    pool_size: int = 10
...
class ResourceManager(ABC):
    """    🎯 Gestionnaire ResourceManager - IA-Influencer-Agent
    ...
    """    
    def __init__(self, config: ResourceManagerConfig = None):
