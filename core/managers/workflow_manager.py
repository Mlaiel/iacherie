...
================================================================================
Module: backend/core/managers/workflow_manager.py
...
class WorkflowManagerConfig:
    """Configuration du gestionnaire WorkflowManager"""    pool_size: int = 10
...
class WorkflowManager(ABC):
    """    🎯 Gestionnaire WorkflowManager - IA-Influencer-Agent
    ...
    """    
    def __init__(self, config: WorkflowManagerConfig = None):
...
def get_workflow_manager() -> WorkflowManager:
    ...
    Returns:
        WorkflowManager: Instance du gestionnaire
