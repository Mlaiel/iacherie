"""
IA Chérie Core Platform - Email Service Core
==========================================
...
communication for all IA Chérie platform needs.
...
Initialize email service core"""
        ...
        self.config = {
            ...
            "default_from": "noreply@iacherie.com",
            "default_timeout": 30
        }
...
Initialize default email templates"""
        ...
        welcome_template = EmailTemplate(
            template_id="welcome",
            name="Welcome Email",
            subject="Welcome to IA Chérie, {{name}}!",
            html_content="""
            <h1>Welcome to IA Chérie!</h1>
            <p>Hi {{name}},</p>
            <p>Welcome to the IA Chérie platform! We're excited to have you on board.</p>
            ...
            <p>Best regards,<br>The IA Chérie Team</p>
            """,
            text_content="""
            Welcome to IA Chérie!
            
            Hi {{name}},
            
            Welcome to the IA Chérie platform! We're excited to have you on board.
        ...
        reset_template = EmailTemplate(
            ...
            name="Password Reset",
            subject="Reset Your IA Chérie Password",
            html_content="""
            <h1>Password Reset Request</h1>
            <p>Hi {{name}},</p>
            <p>You requested a password reset for your IA Chérie account.</p>
            ...
            You requested a password reset for your IA Chérie account.
