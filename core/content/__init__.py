...
Enterprise Content Management Infrastructure for IA Chérie Platform
...
# Import Studios for easy access
try:
    from .video_studio import VideoStudio
    ...
    logger.info("✅ All Studios imported successfully")
except ImportError as e:
    logger.warning(f"⚠️ Could not import some Studios: {e}")
    VideoStudio = None
    ImageStudio = None
    AvatarStudio = None
    AudioStudio = None
