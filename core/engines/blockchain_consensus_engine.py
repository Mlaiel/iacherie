...
class BlockchainConsensusEngineStatus(Enum):
    """États du moteur BlockchainConsensusEngine"""    IDLE = "idle"
...
class BlockchainConsensusEngineConfig:
    """Configuration du moteur BlockchainConsensusEngine"""    enabled: bool = True
    max_workers: int = 4
...
blockchain_consensus_engine = None
