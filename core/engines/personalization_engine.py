...
class PersonalizationEngine(ABC):
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        try:
                    ...
                    # Process request
                    result = await self._handle_get_personalization_engine_request(data)
            
                    # Return response
                    return {"status": "success", "data": result}
            
                except Exception as e:
                    logger.error(f"API handler get_personalization_engine failed: {e}")
...
DEFAULT_CONFIG = PersonalizationEngineConfig()
