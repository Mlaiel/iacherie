...
async def quick_setup():
    ...
    try:
        ...
        if not env_validation['overall_status']:
            print("  Environment validation found issues - continuing with setup...")
...
def run_health_check():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"  Health check completed with warnings (exit code: {result.returncode})")
            return True
            
    except subprocess.TimeoutExpired:
        print("  Health check timed out - system may be slow")
        return True
    except Exception as e:
...
def run_demo():
    ...
    try:
        ...
        print("  Demo timed out - system components may be initializing")
        return True
    except Exception as e:
