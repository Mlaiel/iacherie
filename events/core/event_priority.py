...
class EventPriority(IntEnum):
    ...
    def get_description(self) -> str:
        """Get human-readable description of priority level"""        descriptions = {
    ...
    def get_timeout_seconds(self) -> int:
        """Get recommended timeout for this priority level"""        timeouts = {
    ...
    def get_retry_attempts(self) -> int:
        """Get recommended retry attempts for this priority level"""        retries = {
            EventPriority.LOW: 1,
