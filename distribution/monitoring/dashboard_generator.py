...
Advanced dashboard generation engine for IA Chérie Distribution Platform.
...
<head>
    ...
    <title>{{ dashboard.name }} - IA Chérie Dashboard</title>
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="dashboard-footer">
        <div class="container">
            <p>Generated by IA Chérie Distribution Platform | Auto-refresh: {{ dashboard.refresh_rate }}s</p>
        </div>
    </div>
