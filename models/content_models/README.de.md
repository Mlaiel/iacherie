# Inhaltsmodelle - Unternehmensqualität

## 🎯 Überblick

Multi-Format-Inhaltsmodelle mit Unterstützung für Audio, Video, Bild, Text und Dokumente
...
from models.content_models import index as content_models

# Verfügbare Modelle abrufen
models = content_models.list_available_content_models()
print(f"Verfügbare Modelle: {len(models)}")

# Auf spezifische Modellkategorien zugreifen
registry = content_models.CONTENT_MODELS_REGISTRY
