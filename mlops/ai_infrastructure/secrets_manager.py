...
# SECURITY: # SECURITY: password = os.environ.get("IACHERIE_SECRET_KEY", "default-secret-key").encode() # MOVED TO ENV # MOVED TO ENV
# TODO: Move to environment variables or secure vault
# TODO: Move to environment variables or secure vault
        salt = os.environ.get("IACHERIE_SECRET_SALT", "default-salt").encode()
