# =============================================================================
# IACHERIE MERCHANDISING HUB - COMMERCE DOCKERFILE
# =============================================================================
...
LABEL org.opencontainers.image.title="IA Chérie Merchandising Hub"
LABEL iacherie.service.category="monetization"
LABEL iacherie.service.name="merchandising_hub"
LABEL iacherie.service.port="8050"