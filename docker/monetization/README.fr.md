# Services Docker Monetization

Services Docker professionnels pour la fonctionnalité monetization de la plateforme IA Chérie.

## Aperçu

Ce module fournit des services monetization conteneurisés conçus pour un déploiement à l'échelle entreprise.
...
Multiple specialized Docker services for monetization operations.
...
```env
# MONETIZATION_CONFIG
MONETIZATION_LOG_LEVEL=INFO
MONETIZATION_PORT=8080
```
