# =============================================================================
# IACHERIE ADVERTISING OPTIMIZER - REVENUE DOCKERFILE
# =============================================================================
...
LABEL org.opencontainers.image.title="IA Chérie Advertising Optimizer"
LABEL iacherie.service.category="monetization"
LABEL iacherie.service.name="advertising_optimizer"
LABEL iacherie.service.port="8044"