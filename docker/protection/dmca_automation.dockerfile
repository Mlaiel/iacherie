# =============================================================================
# IACHERIE DMCA AUTOMATION - AUTOMATED DOCKERFILE
# =============================================================================
...
LABEL org.opencontainers.image.title="IA Chérie DMCA Automation"
LABEL iacherie.service.category="protection"
LABEL iacherie.service.name="dmca_automation"
LABEL iacherie.service.port="8024"