...
Professional Docker services for protection functionality in the IA Chérie platform.

## Overview

This module provides containerized protection services designed for enterprise-scale deployment.
