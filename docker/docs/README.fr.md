...
Services Docker professionnels pour la fonctionnalité docs de la plateforme IA Chérie.

## Aperçu

Ce module fournit des services docs conteneurisés conçus pour un déploiement à l'échelle entreprise.
