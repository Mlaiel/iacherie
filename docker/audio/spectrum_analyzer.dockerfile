# =============================================================================
# IACHERIE SPECTRUM ANALYZER - REAL-TIME DOCKERFILE
# =============================================================================
...
LABEL org.opencontainers.image.title="IA Chérie Spectrum Analyzer"
LABEL iacherie.service.category="audio"
LABEL iacherie.service.name="spectrum_analyzer"
LABEL iacherie.service.port="8018"