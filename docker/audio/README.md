...
Professional Docker services for audio functionality in the IA Chérie platform.

## Overview

This module provides containerized audio services designed for enterprise-scale deployment.
