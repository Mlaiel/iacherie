# Services Docker Audio

Services Docker professionnels pour la fonctionnalité audio de la plateforme IA Chérie.

## Aperçu

Ce module fournit des services audio conteneurisés conçus pour un déploiement à l'échelle entreprise.
