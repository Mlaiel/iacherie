# =============================================================================
# IACHERIE WAVEFORM GENERATOR - VISUALIZATION DOCKERFILE
# =============================================================================
...
LABEL org.opencontainers.image.title="IA Chérie Waveform Generator"
LABEL iacherie.service.category="audio"
LABEL iacherie.service.name="waveform_generator"
LABEL iacherie.service.port="8017"