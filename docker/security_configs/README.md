...
Professional Docker services for security_configs functionality in the IA Chérie platform.

## Overview

This module provides containerized security_configs services designed for enterprise-scale deployment.
