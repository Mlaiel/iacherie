# خدمات Docker Security_Configs

خدمات Docker احترافية لوظائف security_configs في منصة IA Chérie.

## نظرة عامة

توفر هذه الوحدة خدمات security_configs المحاطة بحاويات مصممة للنشر على نطاق المؤسسات.
