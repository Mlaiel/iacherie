...
class MonitoringOrchestrator:
    ...
    async def _register_default_metrics(self):
        ...
        default_metrics = [
            MetricDefinition(
                name="iacherie_content_uploads_total",
            ...
            MetricDefinition(
                name="iacherie_api_request_duration_seconds",
            ...
            MetricDefinition(
                name="iacherie_revenue_generated",
                type=MetricType.COUNTER,
            ...
            MetricDefinition(
                name="iacherie_processing_queue_size",
                type=MetricType.GAUGE,
    ...
    async def get_platform_metrics(self, time_range: str = "1h") -> Dict[str, Any]:
        ...
        try:
            metrics = await self.prometheus_collector.query_metrics([
                ...
                "iacherie_revenue_generated",
                "iacherie_processing_queue_size"
            ], time_range)
            
            return {
                "content_uploads": metrics.get("iacherie_content_uploads_total", 0),
                "api_latency": metrics.get("iacherie_api_request_duration_seconds", 0),
                "active_users": metrics.get("iacherie_active_users", 0),
                "revenue": metrics.get("iacherie_revenue_generated", 0),
                "queue_size": metrics.get("iacherie_processing_queue_size", 0),
