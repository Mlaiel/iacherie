...
@dataclass
class MediaContent:
    """Comprehensive media content structure."""    media_id: str
    source_url: str
...
class MediaScraper:
    ...
    def detect_media_type(self, url: str) -> str:
        """Detect media type from URL."""        domain = urlparse(url).netloc.lower()
    ...
    async def extract_media_content(self, url: str) -> Optional[MediaContent]:
        """Extract comprehensive media content information."""        media_type = self.detect_media_type(url)
    ...
    async def _extract_image_content(self, url: str) -> Optional[MediaContent]:
        """Extract image content information."""        try:
            headers = {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'
            }
    ...
    def _is_direct_image_url(self, url: str) -> bool:
        """Check if URL points directly to an image file."""        path = urlparse(url).path.lower()
        image_extensions = ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.webp']
        return any(path.endswith(ext) for ext in image_extensions)
        
    def _generate_image_hash(self, image: Image.Image) -> str:
        """Generate perceptual hash for image similarity."""        try:
    ...
    async def _parse_video_metadata(self, html: str, url: str) -> Dict[str, Any]:
        """Parse video metadata from HTML."""        metadata = {}
    ...
    async def _parse_audio_metadata(self, html: str, url: str) -> Dict[str, Any]:
        """Parse audio metadata from HTML."""        metadata = {}
    ...
    async def _parse_image_metadata(self, html: str, url: str) -> Dict[str, Any]:
        """Parse image metadata from HTML."""        metadata = {}
    ...
    def _extract_open_graph(self, html: str) -> Dict[str, Any]:
        """Extract Open Graph metadata."""        import re
    ...
    async def _parse_youtube_metadata(self, html: str) -> Dict[str, Any]:
        """Parse YouTube-specific metadata."""        import re
    ...
    async def _parse_spotify_metadata(self, html: str) -> Dict[str, Any]:
        """Parse Spotify-specific metadata."""        # Spotify metadata extraction would go here
        return {}
        
    async def _parse_soundcloud_metadata(self, html: str) -> Dict[str, Any]:
        """Parse SoundCloud-specific metadata."""        # SoundCloud metadata extraction would go here
        return {}
        
    async def _parse_instagram_metadata(self, html: str) -> Dict[str, Any]:
        """Parse Instagram-specific metadata."""        # Instagram metadata extraction would go here
        return {}
        
    async def _analyze_video_technical(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze video technical properties."""        return {
    ...
    async def _analyze_audio_technical(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze audio technical properties."""        return {
            'duration_parsed': self._parse_duration(metadata.get('duration', '')),
    ...
    async def _analyze_image_technical(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """Analyze image technical properties."""        return {
    ...
    def _parse_duration(self, duration_str: str) -> Optional[float]:
        """Parse duration string to seconds."""        if not duration_str:
            return None
    ...
    def _extract_filename(self, url: str) -> str:
        """Extract filename from URL."""        path = urlparse(url).path
        return path.split('/')[-1] if path else 'unknown'
        
    def _extract_platform(self, url: str) -> str:
        """Extract platform name from URL."""        domain = urlparse(url).netloc.lower()
    ...
    def _estimate_video_quality(self, metadata: Dict[str, Any]) -> str:
        """Estimate video quality from metadata."""        # Basic quality estimation logic
        return 'medium'  # Placeholder
        
    def _estimate_audio_quality(self, metadata: Dict[str, Any]) -> str:
        """Estimate audio quality from metadata."""        # Basic quality estimation logic
        return 'medium'  # Placeholder
        
    def _estimate_image_quality(self, metadata: Dict[str, Any]) -> str:
        """Estimate image quality from metadata."""        # Basic quality estimation logic
        return 'medium'  # Placeholder
        
    def _categorize_resolution(self, dimensions: Optional[Tuple[int, int]]) -> str:
        """Categorize image resolution."""        if not dimensions:
            return 'unknown'
    ...
    def _check_platform_optimization(self, metadata: Dict[str, Any]) -> bool:
        """Check if video is optimized for platform."""        # Platform optimization check logic
        return True  # Placeholder
        
    def _check_streaming_optimization(self, metadata: Dict[str, Any]) -> bool:
        """Check if audio is optimized for streaming."""        # Streaming optimization check logic
        return True  # Placeholder
        
    def _check_web_optimization(self, metadata: Dict[str, Any]) -> bool:
        """Check if image is optimized for web."""        # Web optimization check logic
        return True  # Placeholder
        
    async def _extract_generic_media(self, url: str) -> Optional[MediaContent]:
        """Extract generic media content when type is unknown."""        try:
            headers = {
                'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'
            }
