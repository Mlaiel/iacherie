...
Enterprise-grade token and session management for IA Chérie platform.
...
class JWTManager:
    ...
    def __init__(self):
        ...
        # Issuer et audience
        self.issuer = "iacherie.platform"
        self.audience = "iacherie.creators"
