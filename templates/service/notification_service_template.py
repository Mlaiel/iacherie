"""{{service_name}} Notification Service for iacherie Platform
{{service_description}}
...
class {{service_class_name}}(BaseService):
    """
    Enterprise Notification Service for iacherie Platform
    ...
    async def _deliver_email(self, notification: Notification) -> bool:
        ...
        try:
            ...
            msg['From'] = f"iacherie <{self.smtp_client['username']}>"
