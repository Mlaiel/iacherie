/**
 * IA Chérie Desktop - Auto Updater Manager
 * 
...
class AutoUpdaterManager extends EventEmitter {
  ...
  setupUpdateServer() {
    ...
    const updateServers = {
      ...
      staging: {
        provider: 'generic',
        url: 'https://staging-updates.iacherie.com'
      },
      development: {
        provider: 'generic',
  ...
  async showUpdateAvailableNotification(info) {
    ...
    const response = await dialog.showMessageBox(mainWindow, {
      ...
      message: `IA Chérie Studio v${info.version} is available`,
  ...
  async showUpdateReadyNotification(info) {
    ...
    const response = await dialog.showMessageBox(mainWindow, {
      type: 'info',
      title: 'Update Ready',
      message: `IA Chérie Studio v${info.version} has been downloaded`,
