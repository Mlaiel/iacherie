...
class Settings:
    ...
    def __init__(self):
        self.app = APISettings()
        self.database = DatabaseSettings()
        self.security = SecuritySettings()
        
        # Set up monitoring as a simple class if import fails
        try:
            from .monitoring_settings import MonitoringSettings
            self.monitoring = MonitoringSettings()
        except ImportError:
            # Create a simple monitoring settings class
            class SimpleMonitoringSettings:
                log_level = "INFO"
                log_format = "json"
            self.monitoring = SimpleMonitoringSettings()
        
        # Set other optional settings to None or simple defaults
        self.ai = None
        self.platforms = None
        self.payments = None
        self.storage = None
