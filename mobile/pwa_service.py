...
Create default PWA configuration."""
    ...
    async def generate_service_worker(self) -> str:
        ...
        service_worker_code = f"""// IA Chérie PWA Service Worker
// Auto-generated by MobilePWAService
// Author: Fahed Mlaiel <mlaiel@live.de>

const CACHE_NAME = 'iacherie-v1.0.0';
...
self.addEventListener('push', (event) => {{
    ...
    const options = {{
        body: 'You have new updates in IA Chérie',
        icon: '/static/icons/icon-192x192.png',
        badge: '/static/icons/badge-72x72.png',
        tag: 'iacherie-notification',
    ...
    event.waitUntil(
        self.registration.showNotification('IA Chérie', options)
    );
}});
...
<body>
    <div class="offline-container">
        ...
        <p class="offline-message">
            Don't worry! IA Chérie works offline too. You can still access your content,
