...
class ContractGenerationSystemStatus:
    """Overall contract generation system status"""    is_healthy: bool = True
...
class ContractGenerationManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete contract generation system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire contract generation system"""        if not self.is_running:
