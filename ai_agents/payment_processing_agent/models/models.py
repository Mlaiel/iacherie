...
class RevenueAllocation(Base):
    ...
    def validate_allocations(self, key, value):
        """Validate allocation percentages sum to total_percentage."""
...
class PaymentTransactionCreate(BaseModel):
    """Pydantic model for creating payment transactions."""
...
class PaymentMethodCreate(BaseModel):
    """Pydantic model for adding payment methods."""
...
class RevenueAllocationCreate(BaseModel):
    """Pydantic model for creating revenue allocations."""
