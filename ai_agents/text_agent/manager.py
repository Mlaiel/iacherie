...
class TextSystemStatus:
    """Overall text system status"""    is_healthy: bool = True
...
class TextManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete text system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire text system"""        logger.info("Shutting down Text System...")
        self.is_running = False
