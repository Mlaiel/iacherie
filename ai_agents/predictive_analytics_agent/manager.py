...
from .core.predictive_analytics_engine import PredictiveAnalyticsEngine
...
class PredictiveAnalyticsManager(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.engine = PredictiveAnalyticsEngine(config)
    ...
    async def start(self) -> None:
        ...
        try:
            logger.info("Starting PredictiveAnalytics System...")
            await self.engine.start()
            self.is_running = True
            logger.info("PredictiveAnalytics System started successfully")
            
        except Exception as e:
            logger.error(f"Failed to start predictive_analytics system: {e}")
            raise
