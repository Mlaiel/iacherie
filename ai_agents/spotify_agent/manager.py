...
class SpotifySystemStatus:
    """Overall spotify system status"""    is_healthy: bool = True
...
class SpotifyManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete spotify system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire spotify system"""        logger.info("Shutting down Spotify System...")
        self.is_running = False
