...
class SupportSystemStatus:
    """Overall support system status"""    is_healthy: bool = True
...
class SupportManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete support system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire support system"""        logger.info("Shutting down Support System...")
        self.is_running = False
