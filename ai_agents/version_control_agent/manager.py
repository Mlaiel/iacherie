...
from .core.version_control_engine import VersionControlEngine
...
class VersionControlManager(BaseAgent):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.engine = VersionControlEngine(config)
    ...
    async def start(self) -> None:
        ...
        try:
            logger.info("Starting Version Control System...")
            await self.engine.start()
            self.is_running = True
            logger.info("Version Control System started successfully")
            
        except Exception as e:
            logger.error(f"Failed to start version control system: {e}")
            raise
    ...
    async def shutdown(self) -> None:
        ...
        try:
            logger.info("Shutting down Version Control System...")
            await self.engine.shutdown()
            self.is_running = False
            logger.info("Version Control System shut down successfully")
