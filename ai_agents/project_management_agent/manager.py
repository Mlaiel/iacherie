...
class ProjectManagementSystemStatus:
    """Overall project management system status"""    is_healthy: bool = True
...
class ProjectManagementManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete project management system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire project management system"""        if not self.is_running:
