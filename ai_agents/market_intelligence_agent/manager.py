...
class MarketIntelligenceSystemStatus:
    """Overall market_intelligence system status"""    is_healthy: bool = True
...
class MarketIntelligenceManager(BaseAgent):
    ...
    async def start(self) -> None:
        """Start the complete market_intelligence system"""        if self.is_running:
    ...
    async def shutdown(self) -> None:
        """Graceful shutdown of the entire market_intelligence system"""        logger.info("Shutting down MarketIntelligence System...")
        self.is_running = False
