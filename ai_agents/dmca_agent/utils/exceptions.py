...
class ErrorSeverity(Enum):
    """Error severity levels for DMCA operations"""    LOW = "low"
    MEDIUM = "medium"
    HIGH = "high"
    CRITICAL = "critical"

class ErrorCategory(Enum):
    """Categories of DMCA operation errors"""    LEGAL_COMPLIANCE = "legal_compliance"
...
class DMCABaseException(Exception):
    ...
    def _log_exception(self):
        """Log the exception with appropriate level based on severity"""        log_data = {
