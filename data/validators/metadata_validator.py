    ...
    validation_results: List[MetadataValidationResult],
        try:
                    ...
                    metrics = {
                        ...
                        "metric_name": "create_metadata_report",
                        "value": output_path if output_path else 0,
                    ...
                    logger.info(f"Metric create_metadata_report collected")
                    return metrics
            
                except Exception as e:
                    logger.error(f"Metric collection create_metadata_report failed: {e}")
                    return None
@dataclass
class MetadataField:
