#!/usr/bin/env python3
"""
Real-time Analytics Endpoints - iacherie Platform
...
async def get_metric(
    metric_id: str,
    time_range: str = Query("24h", pattern="^(1h|6h|12h|24h|7d|30d)$")
):
...
async def get_dashboard_analytics(
    ...
    date_range: Optional[str] = Query("30d", pattern="^(7d|30d|90d|1y)$")
):
