...
try:
    from streaming import streaming_router, streaming_service, StreamType
    STREAMING_AVAILABLE = True
except ImportError:
    STREAMING_AVAILABLE = False
    
try:
    from ai_models import ai_model_manager, ModelType
...
if AI_MODELS_AVAILABLE:
    @enhanced_router.post("/ai/analyze")
    ...
    @enhanced_router.get("/ai/models/stats")
    ...
    @enhanced_router.post("/ai/classify")
    ...
    @enhanced_router.post("/ai/sentiment")
    ...
    @enhanced_router.post("/ai/trend-prediction")
...
if ENHANCED_SECURITY_AVAILABLE:
    @enhanced_router.post("/security/analyze")
    ...
    @enhanced_router.get("/security/dashboard")
    ...
    @enhanced_router.get("/security/blocked-ips")
...
if STREAMING_AVAILABLE:
    @enhanced_router.get("/streaming/stats")
    ...
    @enhanced_router.get("/streaming/rooms/{room_id}/users")
