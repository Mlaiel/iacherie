...
class EmailProvider(NotificationProvider):
    ...
    def __init__(self, smtp_config: Dict[str, Any]):
        ...
        try:
            logger.info(f"Executing EmailProvider __init__")
            ...
            logger.info(f"EmailProvider __init__ completed successfully")
        except Exception as e:
            logger.error(f"EmailProvider __init__ failed: {e}")
            raise
