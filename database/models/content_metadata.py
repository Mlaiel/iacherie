...
class MetadataType(Enum):
    """Metadata type enumeration"""    TECHNICAL = "technical"
...
class ExtractionMethod(Enum):
    """Metadata extraction methods"""    MANUAL = "manual"
    AUTOMATIC = "automatic"
...
class ConfidenceLevel(Enum):
    """Confidence levels for extracted metadata"""    VERY_HIGH = "very_high"      # 95%+
    HIGH = "high"                # 85-94%
    MEDIUM = "medium"            # 70-84%
    LOW = "low"                  # 50-69%
...
class ValidationStatus(Enum):
    """Metadata validation status"""    VALID = "valid"
    INVALID = "invalid"
    PENDING = "pending"
    PARTIAL = "partial"
...
class ContentMetadata(Base):
    ...
    def get_typed_value(self) -> Any:
        """Get the value in its proper type"""        if self.data_type == "string":
    ...
    def is_valid(self) -> bool:
        """Check if metadata is valid"""        return (
    ...
    def needs_validation(self) -> bool:
        """Check if metadata needs validation"""        return (
    ...
    def is_ai_generated(self) -> bool:
        """Check if metadata was generated by AI"""        return self.extraction_method in [
    ...
    def create_metadata(cls, metadata_data: Dict[str, Any], user_content_id: str) -> 'ContentMetadata':
        """Create ContentMetadata from metadata extraction data"""        return cls(
