...
class ContentFingerprint(Base):
    ...
    content_meta_data = Column(JSONB)  # Flexible metadata storage
...
class ProtectionAlert(Base):
    ...
    evidence_meta_data = Column(JSONB)
...
class PlatformIntegration(Base):
    ...
    credentials_meta_data = Column(JSONB)  # Additional platform-specific data
...
System audit and activity logging"""
    ...
    description = Column(Text)
    meta_data = Column(JSONB)  # Additional context data
...
class VectorSimilarity(Base):
    ...
    meta_data_similarity = Column(Float)
