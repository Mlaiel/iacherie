  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Overview of your content, protection, and earnings</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-indigo-500">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Weekly Uploads</p>
              <p className="text-2xl font-bold text-gray-900">{stats?.weeklyUploads}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <p className="text-gray-600 mb-4">Monitor and manage content protection status.</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Upload Wizard</h3>
          </div>
          <p className="text-gray-600 mb-4">Upload and protect new content with ease.</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <p className="text-gray-600 mb-4">Manage team collaborations and projects.</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
          ...
          <p className="text-gray-600 mb-4">Configure revenue streams and payments.</p>
