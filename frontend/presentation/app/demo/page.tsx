...
import { UploadInterface as MediaUploader } from '@/presentation/components/forms/upload_components/UploadInterface';
import CopyrightManager from '@/business/protection/components/CopyrightManager';
import CollaborationHub from '@/presentation/pages/dashboard/main/CollaborationHub';
import AnalyticsView from '@/presentation/pages/dashboard/analytics/AnalyticsView';
import MonetizationPanel from '@/presentation/pages/dashboard/main/MonetizationPanel';
