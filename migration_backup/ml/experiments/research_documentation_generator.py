...
---
*Generated on {{ generation_date }} by IA Chéries Research Documentation System*
*Authors: {{ authors }}*
""",
            "technical_report": """
...
async def example_usage():
    ...
    # 👥 Authors
    authors = [
        Author("Dr. Fahed Mlaiel", "mlaiel@live.de", "IA Chéries Research Lab", "0000-0000-0000-0000"),
        Author("ML Research Team", "research@ainflue.com", "IA Chéries Technologies")
    ]
