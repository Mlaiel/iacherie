...
Project: IA Chéries ML Security - Access Control
...
class AccessControlConfig:
    ...
    creator_protection_mode: bool = True  # IA Chéries-specific
...
class RoleBasedAccessEngine:
    ...
    def _initialize_default_roles(self) -> Dict[str, MLRole]:
        ...
        return {
            ...
            "creator": MLRole(  # IA Chéries-specific role
                name="creator",
    ...
    async def enforce_rbac_policies(self, user_context: UserContext, access_context: AccessContext) -> Dict[str, Any]:
        ...
        try:
            ...
            # Special handling for creator IP protection (IA Chéries-specific)
    ...
    def _apply_creator_protection(self, user_context: UserContext, access_context: AccessContext) -> Dict[str, Any]:
        """Application protection spéciale créateurs IA Chéries"""
        protection_result = {
