...
# IA Chéries Desktop - Testing Automation Script
# 
...
initialize_testing() {
    log "🧪 Starting IA Chéries Desktop Testing Automation"
...
jest.mock('electron', () => ({
  app: {
    ...
    getName: jest.fn(() => 'IA Chéries Desktop'),
    getPath: jest.fn(() => '/tmp'),
    on: jest.fn(),
...
generate_test_report() {
    ...
    cat > "$report_file" << EOF
# IA Chéries Desktop - Testing Report
...
*Generated by IA Chéries Desktop Testing Automation System*
EOF
