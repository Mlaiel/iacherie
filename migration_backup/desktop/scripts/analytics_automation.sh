...
show_header() {
    echo -e "${PURPLE}${BOLD}"
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║              📊 IA CHÉRIES ANALYTICS INTELLIGENCE                   ║"
    echo "║                                                                  ║"
...
<head>
    ...
    <title>IA Chéries Analytics Dashboard</title>
    <style>
...
<body>
    <div class="header">
        <h1>📊 IA Chéries Analytics Intelligence Dashboard</h1>
    ...
    <footer style="text-align: center; margin-top: 30px; color: #666;">
        <p>© 2025 Fahed Mlaiel - IA Chéries Analytics Intelligence</p>
...
show_usage() {
    cat << EOF
${BOLD}IA Chéries Analytics Automation${NC}
