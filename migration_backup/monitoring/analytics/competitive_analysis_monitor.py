"""
IA Chéries Platform - Competitive Analysis Monitor
==============================================
...
class CompetitiveAnalysisMonitor:
    ...
    async def _generate_strategic_insights(self, positioning_analysis: Dict[str, Any], 
        ...
        # Analyze our position (assuming we're "IA Chéries" in the analysis)
        if "IA Chéries" in positioning_analysis:
            our_scores = positioning_analysis["IA Chéries"]
        ...
        if market_leader_name and market_leader_name != "IA Chéries":
