...
class CommunicationAPIsIntegration:
    ...
    async def _ensure_session(self):
        ...
        if self.session is None or self.session.closed:
            headers = {
                "User-Agent": "IA Chéries/1.0 Communication Hub",
    ...
    async def send_transactional_email(
        ...
        default_templates = {
            TemplateCategory.WELCOME: {
                ...
                "content": "Hi {name},\n\nWelcome to IA Chéries! We're excited to have you on board.\n\nBest regards,\nThe IA Chéries Team"
            },
    ...
    welcome_templates = [
        {
            "day": 0,
            "subject": "Welcome to IA Chéries, {name}!",
            "content": "Hi {name},\n\nWelcome to IA Chéries! We're excited to have you join our creator community.\n\nGet started by uploading your first content and connecting your social media accounts.\n\nBest regards,\nThe IA Chéries Team"
        },
        {
            "day": 3,
            "subject": "Getting started with IA Chéries",
            "content": "Hi {name},\n\nHow are you finding IA Chéries so far? Here are some tips to help you get the most out of our platform:\n\n1. Connect all your social media accounts\n2. Upload high-quality content\n3. Engage with your audience\n\nNeed help? Reply to this email and we'll assist you!\n\nBest regards,\nThe IA Chéries Team"
        },
        {
            "day": 7,
            "subject": "Your first week on IA Chéries",
            "content": "Hi {name},\n\nIt's been a week since you joined IA Chéries! We hope you're enjoying the platform.\n\nHere's what you can do next:\n- Explore monetization options\n- Check your analytics\n- Join our creator community\n\nKeep creating amazing content!\n\nBest regards,\nThe IA Chéries Team"
        },
        {
            "day": 14,
            "subject": "Maximize your earnings on IA Chéries",
