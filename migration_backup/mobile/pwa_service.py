...
Create default PWA configuration."""
    ...
    async def generate_service_worker(self) -> str:
        ...
        service_worker_code = f"""// IA Chéries PWA Service Worker
...
self.addEventListener('push', (event) => {{
    ...
    const options = {{
        body: 'You have new updates in IA Chéries',
    ...
    event.waitUntil(
        self.registration.showNotification('IA Chéries', options)
    );
}});
...
<head>
    ...
    <title>IA Chéries - Offline</title>
    <style>
        body {
...
<body>
    <div class="offline-container">
        ...
        <p class="offline-message">
            Don't worry! IA Chéries works offline too. You can still access your content,
