"""IA Chéries Core Platform - Notification System Core
=================================================
    ...
    def _load_default_templates(self):
        ...
        default_templates = [
            NotificationTemplate(
                ...
                body_template="Welcome to IA Chéries! We're excited to have you join our creator community.",
                html_template="<h1>Welcome to IA Chéries!</h1><p>Hello {{user_name}}, we're excited to have you join our creator community.</p>",
            ...
            NotificationTemplate(
                ...
                channel=NotificationChannel.EMAIL,
                subject_template="Verify your IA Chéries account",
