...
Module de démonstrations ultra sophistiquées pour le système d'affiliation IA Chéries.
...
def get_module_info() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Module de démonstrations ultra sophistiquées pour système d'affiliation IA Chéries"
    }
