...
et administration centralisée pour la plateforme IA Chéries.
...
class EnterpriseDatabaseConsole:
    ...
    def __init__(self, config: ConsoleConfiguration):
        ...
        # FastAPI application
        self.app = FastAPI(
            title="IA Chéries Enterprise Database Console",
    ...
    def _setup_routes(self):
        ...
        async def dashboard_home():
            ...
            return await self._render_dashboard_template("dashboard.html", {
                "title": "IA Chéries Database Console",
    ...
    async def _render_dashboard_template(self, template_name: str, context: Dict[str, Any]) -> str:
        ...
        <body>
            <div class="header">
                <h1>🖥️ IA Chéries Enterprise Database Console</h1>
