...
class ModelPerformanceAnalyzer:
    ...
    async def _analyze_model_characteristics(self, model: Any) -> Dict[str, Any]:
    ...
    async def _run_inference(self, model: Any, batch_data: Any) -> Any:
    ...
    def _get_sample_data(self, model: Any) -> Any:
