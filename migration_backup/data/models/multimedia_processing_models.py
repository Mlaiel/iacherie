...
class MultimediaAssetModel(Base):
    ...
    # Metadata
    meta_data_extracted = Column(JSONB, default=dict)  # Extracted metadata
    ...
    custom_meta_data = Column(JSONB, default=dict)     # Custom metadata
...
class ProcessingJobModel(Base):
    ...
    meta_data_updated = Column(Boolean, default=False)
