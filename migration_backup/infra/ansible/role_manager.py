...
"""
Ansible Role Manager for IA Chéries Platform
========================================
...
class RoleManager:
    ...
    def __init__(self, roles_path: str = "/home/runner/work/IA Chéries/IA Chéries/infra/ansible/roles"):
    ...
    def _create_meta_main(self, role_path: Path, meta: Dict[str, Any], dependencies: List[str]):
        ...
        meta_content = {
            "galaxy_info": {
                "author": "Fahed Mlaiel",
                "description": meta.get("description", "IA Chéries infrastructure role"),
                "company": "IA Chéries Platform",
                "license": "Proprietary",
    ...
    def create_standard_roles(self) -> bool:
        """Create standard IA Chéries infrastructure roles"""
        try:
            # Common setup role
