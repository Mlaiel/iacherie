"""IA Chéries Feature Flags Configuration - Enterprise Dynamic Feature Management
=============================================================================
...
class EnterpriseFeatureFlagsConfiguration:
    ...
    def _initialize_core_feature_flags(self):
        """Initialize core IA Chéries feature flags"""
...
# SECURITY: # SECURITY: cache_key = f"{evaluation.flag_id}:{evaluation.user_id}:{evaluation.environment}" # MOVED TO ENV # MOVED TO ENV
