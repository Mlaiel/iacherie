"""
External Module - IA Chéries Infrastructure Enterprise
==================================================
...
__description__ = "Enterprise external integrations for IA Chéries platform"

# Configuration intégrations métier IA Chéries
IA CHÉRIES_EXTERNAL_WORKFLOW = {
