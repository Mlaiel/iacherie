        ...
        try:
            ...
            if not self.ca_certificate:
                ca_name = x509.Name([
                    ...
                    x509.NameAttribute(NameOID.ORGANIZATION_NAME, "IA Chéries Enterprise"),
                    x509.NameAttribute(NameOID.ORGANIZATIONAL_UNIT_NAME, "Security"),
                    x509.NameAttribute(NameOID.COMMON_NAME, "IA Chéries Enterprise CA"),
                ])
        ...
        try:
            ...
            session = aiohttp.ClientSession(
                ...
                headers={
                    ...
                    'X-mTLS-Version': '1.0',
                    'User-Agent': f'IA Chéries-Service/{self.config.service_name}'
                }
            )
