...
Collaboration Service Template for IA Chéries Platform
==================================================
...
class WorkspaceMessageRequest(BaseModel):
    ...
    message_type: str = Field("text", pattern="^(text|file|image|audio|video)$")
...
class CollaborationService(BaseMicroservice):
    """
    Enterprise Collaboration Service for IA Chéries Platform
...
def create_collaboration_app() -> FastAPI:
    ...
    app = FastAPI(
        title="IA Chéries Collaboration Service",
