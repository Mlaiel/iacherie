...
REST API Template for IA Chéries Microservices Platform
===================================================
...
class RestApiConfig(ServiceConfig):
    ...
    api_title: str = Field(default="IA Chéries API Service", description="API title")
...
def create_rest_api_service(
    ...
    api_title: str = "IA Chéries REST API",
    api_description: str = "Enterprise REST API service for IA Chéries platform"
) -> RestApiTemplate:
