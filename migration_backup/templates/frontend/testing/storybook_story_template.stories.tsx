...
const buttonMeta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile button component with multiple variants, sizes, and states. Part of the IA Chéries Enterprise Design System.',
      },
    },
  },
  argTypes: {
...
export const ComponentsShowcase = () => {
  ...
  return (
    <div className="p-8 space-y-8">
      <div>
        <h2 className="text-2xl font-bold mb-4">IA Chéries Components Showcase</h2>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Welcome to IA Chéries Enterprise Platform</p>
