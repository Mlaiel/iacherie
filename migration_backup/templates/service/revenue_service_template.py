"""{{service_name}} Revenue Service for IA Chéries Platform
{{service_description}}
...
class {{service_class_name}}(BaseService):
    """
    Enterprise Revenue Service for IA Chéries Platform
        ...
        try:
            payment = paypalrestsdk.Payment({
                ...
                "transactions": [{
                    ...
                    "description": request.description or "IA Chéries Platform Payment"
                }],
                "redirect_urls": {
    ...
    async def _process_stripe_payout(
        ...
        try:
            payout = stripe.Payout.create(
                ...
                description=request.description or "IA Chéries Creator Payout"
            )
        ...
        try:
            payout = paypalrestsdk.Payout({
                "sender_batch_header": {
                    ...
                    "email_subject": "IA Chéries Creator Payout"
                },
                "items": [{
                    ...
                    "note": request.description or "IA Chéries Creator Payout",
