"""Passwordless Authentication Template for IA Chéries Platform
...
class PasswordlessAuthenticationService:
    """Comprehensive passwordless authentication service for IA Chéries platform
    ...
    def __init__(self):
        ...
        self.rp_name = settings.WEBAUTHN_RP_NAME or "IA Chéries Platform"
