...
Complete documentation system for IA Chérie Creator Economy platform.
...
def create_api_validator(project_root: str = None):
    ...
    if project_root is None:
        project_root = "/home/runner/work/IA Chérie/IA Chérie"
    return APIDocumentationValidator(project_root)

# Module initialization message
import logging
logger = logging.getLogger(__name__)
logger.info("IA Chérie Documentation Module initialized - Enterprise Creator Economy Documentation System v1.0.0")
