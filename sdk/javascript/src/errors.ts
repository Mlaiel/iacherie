 ...
 */
export class iacherieSdkError extends Error {
 ...
 */
export class ApiError extends iacherieSdkError {
  constructor(
    message: string,
 ...
 * Implementation: Security + Backend Senior
 */
export class AuthenticationError extends iacherieSdkError {
 ...
 */
export class AuthorizationError extends iacherieSdkError {
 ...
 */
export class NetworkError extends iacherieSdkError {
 ...
 * Implementation: DevOps + Backend Senior
 */
export class TimeoutError extends iacherieSdkError {
 ...
 * Implementation: Security + Backend Senior
 */
export class ValidationError extends iacherieSdkError {
  constructor(
    message: string,
 ...
 * Implementation: DevOps + Security
 */
export class ConfigurationError extends iacherieSdkError {
 ...
 */
export class StreamingError extends iacherieSdkError {
  constructor(
    message: string,
 ...
 */
export class AIProcessingError extends iacherieSdkError {
  constructor(
    message: string,
 ...
 */
export class SecurityError extends iacherieSdkError {
...
export class ErrorHandler {
   ...
   */
  static parseError(error: any): iacherieSdkError {
    if (error instanceof iacherieSdkError) {
      return error;
    }
    ...
    return new iacherieSdkError(error.message || 'Unknown error occurred');
  }

  /**
   * Check if error is retryable
   */
  static isRetryable(error: iacherieSdkError): boolean {
   ...
   */
  static getRetryDelay(error: iacherieSdkError, attempt: number): number {
   ...
   * Implementation: Security + DevOps
   */
  static logError(error: iacherieSdkError, context?: Record<string, any>): void {
