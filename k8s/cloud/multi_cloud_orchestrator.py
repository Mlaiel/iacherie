...
Initialize multi-cloud orchestrator"""
    ...
    def _create_aws_deployment_config(self, target: DeploymentTarget) -> AWSDeploymentConfig:
        try:
            ...
            logger.error(f"Error in _create_aws_deployment_config: {e}")
            
        try:
            logger.info(f"Executing _create_azure_deployment_config")
        except Exception as e:
            logger.error(f"Error in _create_azure_deployment_config: {e}")
        ...
        try:
            ...
            logger.error(f"Error in _create_gcp_deployment_config: {e}")
            logger.error(f"Error in _create_gcp_deployment_config: {e}")
