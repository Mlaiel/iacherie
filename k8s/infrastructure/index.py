...
@dataclass
class IiaCherieInfrastructureConfig:
...
class IiaCherieInfrastructureManager:
    """
    ...
    def __init__(self, config: IiaCherieInfrastructureConfig):
        self.config = config
...
async def deploy_ia_influencer_production_infrastructure(
    ...
    """
    config = IiaCherieInfrastructureConfig(
    ...
    manager = IiaCherieInfrastructureManager(config)
...
__all__ = [
    'IiaCherieInfrastructureManager',
    'IiaCherieInfrastructureConfig', 
    'DeploymentMode',
