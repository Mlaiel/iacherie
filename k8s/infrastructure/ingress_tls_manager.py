...
for automatic TLS certificate management for the IA Chérie platform.
...
class TLSConfig:
    ...
    email: str = "admin@iacherie.com"
    domains: List[str] = field(default_factory=lambda: ["*.iacherie.com", "iacherie.com"])
    staging: bool = False
...
class IngressTLSManager:
    ...
    def create_wildcard_certificate(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "spec": {
                "secretName": "iacherie-wildcard-tls",
                "issuerRef": {
