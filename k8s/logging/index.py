...
async def get_logging_system(config: Optional[Dict[str, Any]] = None) -> IiaCherieLoggingSystem:
    """
Get or create global logging system instance"""
    global _logging_system
    
    if _logging_system is None:
        _logging_system = IiaCherieLoggingSystem(config)
