...
validate_databases() {{
    ...
    check "PostgreSQL Connectivity" "kubectl run postgresql-test --rm -i --tty --image=postgres:15.4 --restart=Never -- psql -h ia-influencer-postgresql.ia-influencer.svc.cluster.local -U iiacheriencer -d ia_influencer_platform -c 'SELECT 1;'"
