...
Initialize performance monitor"""
    ...
    async def _send_performance_alert_notifications(
        ...
        try:
            notification_payload = {
                ...
                "system": "iacherie_performance_monitor",
    ...
    async def _send_email_alert(self, notification_payload: Dict[str, Any]) -> None:
        ...
        try:
            ...
            msg['Subject'] = f"[IACHERIE PERF] {notification_payload['severity'].upper()}: {notification_payload['rule_name']}"
            
            # Email body
            body = f"""
            IACHERIE PERFORMANCE ALERT
            ========================
    ...
    async def _send_slack_alert(self, notification_payload: Dict[str, Any]) -> None:
        ...
        try:
            ...
            slack_payload = {
                "text": f"{emoji} IA Chérie Performance Alert: {notification_payload['rule_name']}",
                "attachments": [
                    {
                        "color": color,
                        "fields": [
                        ...
                        "footer": "IA Chérie Performance Monitor",
    ...
    async def _send_sms_alert(self, notification_payload: Dict[str, Any]) -> None:
        ...
        try:
            ...
            sms_message = f"CRITICAL: IA Chérie {notification_payload['metric_name']} alert: {notification_payload['current_value']:.1f} exceeds {notification_payload['threshold']}. Check system immediately."
