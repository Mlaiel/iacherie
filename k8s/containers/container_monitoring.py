    ...
    async def _setup_alert_rules(self) -> None:
        ...
        try:
            alert_rules = [
                ...
                AlertRule(
                    name="IiaCherieAPIHighErrorRate",
                ...
                AlertRule(
                    name="IiaCherieDatabaseConnectionsHigh",
                ...
                AlertRule(
                    name="IiaCherieStorageSpaceHigh",
