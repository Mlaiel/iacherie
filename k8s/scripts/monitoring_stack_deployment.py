#!/usr/bin/env python3
"""🔧 Monitoring Stack Deployment Manager - IA Chérie Platform
==========================================================
...
Monitoring stack configuration"""
    namespace: str = "iacherie-monitoring"
            ...
            namespace_manifest = client.V1Namespace(
                metadata=client.V1ObjectMeta(
                    ...
                    labels={
                        ...
                        "app.kubernetes.io/managed-by": "iacherie-platform"
                    }
                )
            )
...
if __name__ == "__main__":
    ...
    monitoring_config = MonitoringConfig(
        namespace=os.getenv('MONITORING_NAMESPACE', 'iacherie-monitoring'),
