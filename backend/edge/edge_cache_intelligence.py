...
class AIPoweredCacheEngine:
    ...
    async def _get_creator_popularity_factor(self, creator_id: str) -> float:
        """Récupère le facteur de popularité d'un créateur."""        # Simulation basée sur historique cache
...
class GeographicCacheDistributor:
    ...
    async def _determine_target_regions(self, creator_id: str, content_type: ContentType) -> List[str]:
        """Détermine les régions cibles pour le contenu."""        # Pour l'instant, distribution par défaut
    ...
    async def get_system_analytics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "tier_stats": {},                "geo_stats": {},                "prediction_accuracy": 0.85,                "system_health": "optimal"
            }
