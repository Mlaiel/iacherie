...
# Créer des alias pour noms courts attendus
MusicianOptimizer = MusicianPerformanceOptimizer
BloggerOptimizer = BloggerContentAccelerator
BloggerAccelerator = BloggerContentAccelerator  # Alias alternatif
PhotographerOptimizer = PhotographerImageOptimizer
PhotographerProcessor = PhotographerImageOptimizer  # Alias alternatif
InfluencerOptimizer = InfluencerEngagementBooster
InfluencerBooster = InfluencerEngagementBooster  # Alias alternatif
ComedianOptimizer = ComedianVideoEnhancer
ComedianEnhancer = ComedianVideoEnhancer  # Alias alternatif
PerformanceEngine = MultiFormatPerformanceEngine

# Enum alias
OptimizationTarget = PerformanceMetric
