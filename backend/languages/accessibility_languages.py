...
class AccessibilityLanguageEngine:
    ...
    async def _check_guideline_compliance(self, content: str, guideline: AccessibilityGuideline, language_code: str) -> bool:
        """
    ...
    async def _describe_visual_element(self, visual_element: Dict[str, str], language_code: str) -> str:
        """
