...
class GameTransaction:
    """Représente une transaction dans le jeu"""
    transaction_id: str = field(default_factory=lambda: str(uuid.uuid4()))
    player_id: str = ""
    transaction_type: str = "purchase"  # purchase, sale, income, expense
    amount: Decimal = Decimal('0')
    currency_type: str = "cash"  # cash, gems, points
...
@dataclass
class GameChallenge:
    """Représente un défi dans le jeu"""
    challenge_id: str = field(default_factory=lambda: str(uuid.uuid4()))
    name: str = ""
    description: str = ""
    challenge_type: str = "daily"  # daily, weekly, special
...
@dataclass
class GameEvent:
    """Représente un événement dans le jeu"""
    event_id: str = field(default_factory=lambda: str(uuid.uuid4()))
    event_type: str = "bonus"  # bonus, sale, competition, special
    name: str = ""
    description: str = ""
    start_time: datetime = field(default_factory=lambda: datetime.now(timezone.utc))
    end_time: Optional[datetime] = None
...
@dataclass
class GameUpgrade:
    """Représente une amélioration dans le jeu"""
    upgrade_id: str = field(default_factory=lambda: str(uuid.uuid4()))
    name: str = ""
    description: str = ""
    upgrade_type: str = "permanent"  # permanent, temporary, boost
...
class PlayerStats:
    ...
    biggest_purchase: Decimal = Decimal('0')
    fastest_income_rate: Decimal = Decimal('0')
