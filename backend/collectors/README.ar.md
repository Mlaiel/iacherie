...
توفر وحدة جمع البيانات (Collectors) بنية تحتية موحدة ومتطورة لمراقبة المحتوى على مستوى المؤسسات لمنصة iacherie. تقوم هذه الوحدة بدمج 16 جامع بيانات فردي للمنصات في 6 جامعات بيانات منطقية مدمجة مع الحفاظ على التوافق مع الإصدارات السابقة.
...
**المنصة**: نظام مراقبة المبدعين iacherie  
