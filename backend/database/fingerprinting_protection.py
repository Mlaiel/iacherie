...
class ContentFingerprint(Base):
    ...
    # Metadata
    content_meta_data = Column(JSONB, default={})
...
class ContentProtection(Base):
    ...
    # Protection metadata
    protection_meta_data = Column(JSONB, default={})
...
class ContentViolation(Base):
    ...
    violator_meta_data = Column(JSONB, default={})
...
class FraudDetection(Base):
    ...
    target_meta_data = Column(JSONB, default={})
...
class BlacklistEntry(Base):
    ...
    additional_meta_data = Column(JSONB, default={})
...
class VectorEmbedding(Base):
    ...
    embedding_meta_data = Column(JSONB, default={})
