...
class SeedManager:
    ...
    async def initialize_all_seeds(self, force_reinitialize: bool = False) -> Dict[str, Any]:
        """Initialize all seed data using the new orchestrator."""
                 await self.orchestrator.initialize_all(parallel=True, validate=True)
