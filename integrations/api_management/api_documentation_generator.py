#!/usr/bin/env python3
"""
🚀 IA Chérie Enterprise - API Documentation Generator
...
class APIDocumentationSpec:
    ...
    title: str = "IA Chérie Enterprise API"
    version: str = "1.0.0"
    description: str = ""
...
class CodeExampleGenerator:
    ...
    async def _generate_python_example(self, endpoint: APIEndpoint, base_url: str) -> str:
        ...
        # API configuration
        code += f"# IA Chérie Enterprise API - {endpoint.summary}\n"
...
class OpenAPIGenerator:
    ...
    async def generate_openapi_spec(self, spec: APIDocumentationSpec, 
        ...
        # Add custom IA Chérie extensions
        openapi_spec["x-iacherie-enterprise"] = {
    ...
    async def _generate_endpoint_spec(self, endpoint: APIEndpoint, 
        ...
        # Add IA Chérie business logic annotations
