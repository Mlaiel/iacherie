# IA Chérie Infrastructure Module - Ansible Playbook Orchestrator
# =============================================================
# 
# Enterprise-grade Ansible playbook orchestration for IA Chérie platform
...
class PlaybookOrchestrator:
    ...
    def __init__(self, ansible_config_path: Optional[str] = None):
        ...
        self.ansible_config_path = ansible_config_path or "/home/runner/work/IA Chérie/IA Chérie/infra/ansible"
