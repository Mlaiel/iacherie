...
```mermaid
graph TB
    A[مدير تكوين الذكاء الاصطناعي] --> B[منظم الشبكات العصبية]
    A --> C[محرك نشر النماذج]
    A --> D[مدير خط أنابيب التدريب]
    A --> E[مركز تحسين الاستنتاج]
    ...
    C --> J[النشر التلقائي للتوسع]
    C --> K[توزيع الذكاء الاصطناعي الطرفي]
    C --> L[تنظيم الذكاء الاصطناعي السحابي]
    C --> M[الحوسبة الكمية]
    
    D --> N[التدريب الموزع]
    D --> O[التعلم الفيدرالي]
    D --> P[التعلم بالنقل]
    D --> Q[خطوط أنابيب AutoML]
    
    E --> R[الاستنتاج في الوقت الفعلي]
    E --> S[المعالجة المجمعة]
    E --> T[الذكاء الاصطناعي المتدفق]
    E --> U[الحوسبة الطرفية]
```
